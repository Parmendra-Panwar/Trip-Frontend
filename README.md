...
TripLinker is a high-performance mobile/web application designed for the modern traveler. It bridges the gap between social networking and travel planning, offering seamless booking experiences alongside community engagement.
...
1. **Clone the repo:**
```bash
git clone https://github.com/Parmendra-Panwar/Trip-Frontend.git
